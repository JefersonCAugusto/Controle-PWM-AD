...
;Controle PWM atraves de conversores AD.c,63 :: 		Lcd_Out(1, 1, "Duty Cycle: ");            // imprime linha 1 coluna1
	...
	CALL        _Lcd_Out+0, 0
;Controle PWM atraves de conversores AD.c,65 :: 		PWM1_Init(5000);                  // 1nicializa módulo PWM 5Khz
	BSF         T2CON+0, 0, 0
	BCF         T2CON+0, 1, 0
	MOVLW       99
	MOVWF       PR2+0, 0
...
L_main0:
;Controle PWM atraves de conversores AD.c,71 :: 		leituraAD= ADC_Read(0);          // lê Canal AD em uso
